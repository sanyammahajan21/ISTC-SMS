...
import { downloadMarksAPI_Teacher, enterMarksAPI_Teacher } from "../../../Assets/backendAPIs";

const StudentTable = ({ studentsdata, index }) => {
    ...
    const handleSubmitMarks = async () => {
        try {
            const url = `${enterMarksAPI_Teacher}?index=${index}`;
    ...
    return (
        <div className=" overflow-auto pb-40 h-screen ">
                    ...
                    <tbody>
                        {paginatedData.map((student, index) => (
                            <tr key={index} className={index % 2 === 0 ? "bg-indigo-200" : ""}>
                                ...
                                <td className="cursor-pointer" style={{ border: "1px solid black", padding: "5px" }}>
                                    <input
                                        type="text"
            ...
            <div className="flex justify-between mx-auto mt-10 max-w-[600px]">

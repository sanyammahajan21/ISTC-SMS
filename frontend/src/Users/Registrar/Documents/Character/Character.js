...
import { downloadMultipleCCsAPI_Registrar, getCoursesAPI_Admin, getCoursesAPI_Registrar, getPassedStudentsAPI_Registrar } from "../../../../Assets/backendAPIs";
...
const Character = () => {
  ...
  const downloadMultipleHandler = async () => {
    ...
    try {
      ...
      const apiUrl = downloadMultipleCCsAPI_Registrar;
      ...
      link.href = url;
      link.setAttribute("download", "Character_Certificates.pdf"); // Set the filename
      ...
      {!showTable ? (
          ...
          <div className="flex justify-center mt-36">
            <div className="w-full max-w-sm p-4 space-y-6 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-200 dark:border-gray-300">
              <h5 className="text-xl font-medium text-black-blue">
                Select Fields for Character Certificate
              </h5>
        ...
        <div className="w-[55rem] ">
          ...
          <div className="container justify-center overflow-auto mb-11 py-7">
            <CharacterTable data={student} course={formData.course} />
          </div>
        </div>
      )}
    </div>
